As you have seen from applying Array.prototype.map(),
  or simply map() earlier, the map method returns an array of the same length as the one it was called on. 
...
Array.prototype.myMap = function(callback) {
  ...
  this.forEach((elements, indexess, originalArr) =>
    newArray.push(callback(elements, indexess, originalArr))
    );
