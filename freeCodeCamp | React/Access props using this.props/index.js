...
To access props within a class component, you preface the code that you use to access 
...
Here, give Welcome a prop of name and assign it a value of a string. Within the child, Welcome, access the name prop within the strong tags.
