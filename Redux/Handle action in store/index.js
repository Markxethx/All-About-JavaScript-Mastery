After an action is created and dispatched, 
  ...
  responsible for the state modifications that take place in response to actions. 
...
must always return a new copy of state and never modify state directly. Redux does not enforce state 
immutability, however, you are responsible for enforcing it in the code of your reducer functions.
