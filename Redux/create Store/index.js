...
the entire state of your application. This means if you had a React app 
...
This is the first important principle to understand when learning Redux: the Redux store is 
...
The Redux store is an object which holds and manages application state. There is a method called createStore() 
on the Redux object, which you use to create the Redux store. This method takes a reducer function as a required 
argument. The reducer function is covered in a later challenge, and is already defined for you in the code editor. 
